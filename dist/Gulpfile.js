...
gulp.task('htmlmin', function () {
    return gulp.src(paths.html).pipe(htmlmin({
        removeComments: true,
...
gulp.task('minifycss', function () {
    return gulp.src(paths.css).pipe(minify())
    //   .pipe(rename({suffix:'.min'}))
    .pipe(gulp.dest('dist'));
});

gulp.task('concatJs', function () {
    return gulp.src(paths.js).pipe(concat('app.js')).pipe(uglify('app.js')).pipe(gulp.dest('dist/scripts'));
});

gulp.task('uglify', function () {
    return gulp.src(paths.uglifyJs).pipe(uglify()).pipe(gulp.dest('dist'));
});
...
gulp.task('useref', function () {
    return gulp.src('./src/pass.html').pipe(useref()).pipe(gulp.dest('dist'));
});
...
function doCompileSass(opt) {
    ...
    .on('error', sass.logError).pipe(sourcemaps.write()).pipe(sourcemaps.write('maps', {
...
gulp.task('browsersync', function () {
    var files = ['./**/*.*', './**/*.html', './**/*.scss', './**/*.css', './**/*.+(jpg|png|gif)', './**/*.js'];
